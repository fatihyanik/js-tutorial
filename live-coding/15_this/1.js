// "this"
// "this" is a keyword, not a variable, so you cannot assign "this" a value with an assignment statement
...
console.log('The value of "this" in user is ' + user.thisValue); // The value of "this" in user is [object Object]
...
console.log(user.getName()); 
// if the inner function is an arrow function, the value of "this"
...
console.log(jim.age); // 43 
console.log(jim); // User { name: 'Jim', age: 43 }
jim.address = '1600 Pennsylvania Ave.';
console.log(jim); // User { name: 'Jim', age: 43, address: '1600 Pennsylvania Ave.' }

// 4. indirectly, with "call" or "apply"
const getName = function() {
    return this.name;
}
console.log(getName.call(jim)); // Jim
console.log(jim.name); // Jim
console.log(getName.call(jim) === jim.name); // true