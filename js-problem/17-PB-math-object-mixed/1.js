...
let randomCountryFromTheArray = countriesArray[Math.floor(Math.random() * countriesArray.length)];
...
let randomNumberFromTheNumbersString = Math.abs(numbersArray[randomNumbersNumber]);

console.log("absolute value of a random number from the numbers string: ", randomNumberFromTheNumbersString);