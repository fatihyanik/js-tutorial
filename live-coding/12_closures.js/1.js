...
// You may not know that inner functions have access to the variables of outer functions even after the outer functions have returned. 
...
console.log(thirteenCounter()); // 13
...
console.log(myCounter()); // 13

// inner functions can update the variables of outer functions even after those outer functions have returned
function outer3() {
    let count = 0;
    function inner3() {
        count += 1;
